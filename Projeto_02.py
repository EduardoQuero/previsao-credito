...
st.set_page_config(
    ...
    page_icon="https://raw.githubusercontent.com/EduardoQuero/previsao-renda/main/ebac-course-utils/media/icon/favicon.ico",
    layout="wide",
...
<img src="https://raw.githubusercontent.com/EduardoQuero/previsao-renda/main/ebac-course-utils/media/logo/newebac_logo_black_half.png" alt="ebac-logo" width=50%>
</div>

# **Profissão: Cientista de Dados**
### [**Projeto #02** | Previsão de renda](https://github.com/EduardoQuero/previsao-renda)
...
st.markdown('# <div style="text-align:center"> [Previsão de renda](https://github.com/EduardoQuero/previsao-renda) </div>',
            unsafe_allow_html=True)
...
filepath = "https://raw.githubusercontent.com/EduardoQuero/previsao-renda/main/input/previsao_de_renda.csv"
...
st.markdown('[Simulando a previsão de renda](https://eduardo-quero-ebac-projeto02-previsao-renda.streamlit.app/~/+/Simulac%CC%A7a%CC%83o)')
